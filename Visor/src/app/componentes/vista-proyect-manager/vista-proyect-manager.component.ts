...
@Component({
  selector: 'app-vista-proyect-manager',
  templateUrl: './vista-proyect-manager.component.html',
  styleUrls: ['./vista-proyect-manager.component.css']
})
export class VistaProyectManagerComponent implements OnInit, OnChanges {
