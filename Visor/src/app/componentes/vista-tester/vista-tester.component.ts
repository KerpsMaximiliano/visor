...
@Component({
  selector: 'app-vista-tester',
  templateUrl: './vista-tester.component.html',
  styleUrls: ['./vista-tester.component.css']
})
export class VistaTesterComponent implements OnInit, OnChanges{
